...
public class BoardInventory {
	...
	public static final int BATTLE_PLAYER_STRENGTH = INDEXER;
	static {
		INDEXER += PLAYER_COUNT;
	}	
	public static final int BATTLE_PLAYER_SHIELD = INDEXER;
	static {
		INDEXER += PLAYER_COUNT;
	}	
	public static final int BATTLE_PLAYER_DAMAGE = INDEXER;
	static {
		INDEXER += PLAYER_COUNT;
	}	
...
//	public static final int BATTLE_DEFENDER_DAMAGE = INDEXER++;
	public static final int BATTLE_PLAYER_WON = INDEXER; // 1 yes, -1 no
	static {
		INDEXER += PLAYER_COUNT;
	}	
	...
	// tile was already selected for recruit
	public static final int TILE_SELECTION_DONE = INDEXER;
	static {
		INDEXER += TILE_COUNT;
	}
	...
	public static final int STATE_PICK_FINAL_DI_CARDS = INDEXER;
	static {
		INDEXER += PLAYER_COUNT;
	}
	...
	static {
		...
		registerNumber("BATTLE_ATTACKER_STRENGTH ", BATTLE_PLAYER_STRENGTH);
		registerNumber("BATTLE_ATTACKER_SHIELD ", BATTLE_PLAYER_SHIELD);
		registerNumber("BATTLE_ATTACKER_DAMAGE ", BATTLE_PLAYER_DAMAGE);
//		registerNumber("BATTLE_PLAYER_IS_ATTACKER ", BATTLE_PLAYER_IS_ATTACKER);
		registerNumber("BATTLE_PLAYER_WON ", BATTLE_PLAYER_WON);
...
//		registerNumber("BATTLE_DEFENDER_WON ", BATTLE_DEFENDER_WON);
		...
		registerNumber("TILE_SELECTION_DONE ", TILE_SELECTION_DONE);
		...
		registerNumber("PLAYER_BATTLE_CARD_VISIBLE ", PLAYER_BATTLE_CARD_VISIBLE);
		...
		registerNumber("STATE_PICK_FINAL_DI_CARDS ", STATE_PICK_FINAL_DI_CARDS);
	}
	...
	public static String describeCanonicalFormat(ByteCanonicalForm canonicalForm) {
		...
		describeCanonicalFormat(canonicalForm, build);
		
		return build.toString();

	}

	public static void describeCanonicalFormat(ByteCanonicalForm canonicalForm, StringBuilder build) {
		byte[] bs = canonicalForm.getCanonicalForm();
		describeCanonicalFormat(bs, build);
	}
	...
	public static void describeCanonicalFormat(byte[] bs, StringBuilder build) {
	...
	public static void main(String[] args) {
		...
		System.out.println("BATTLE_ATTACKER_STRENGTH " + BATTLE_PLAYER_STRENGTH);
		System.out.println("BATTLE_ATTACKER_SHIELD " + BATTLE_PLAYER_SHIELD);
		System.out.println("BATTLE_ATTACKER_DAMAGE " + BATTLE_PLAYER_DAMAGE);
//		System.out.println("BATTLE_PLAYER_IS_ATTACKER " + BATTLE_PLAYER_IS_ATTACKER);
		System.out.println("BATTLE_PLAYER_WON " + BATTLE_PLAYER_WON);
...
//		System.out.println("BATTLE_DEFENDER_WON " + BATTLE_DEFENDER_WON);
		...
		System.out.println("TILE_SELECTION_DONE " + TILE_SELECTION_DONE);
		...
		System.out.println("PLAYER_BATTLE_CARD_VISIBLE " + PLAYER_BATTLE_CARD_VISIBLE);
		...
		System.out.println("STATE_PICK_FINAL_DI_CARDS " + STATE_PICK_FINAL_DI_CARDS);
...
//BATTLE_ATTACKER_SHIELD 139
//BATTLE_ATTACKER_DAMAGE 141
//BATTLE_PLAYER_WON 143
//FREE_RECRUIT_LEFT 145
//TILE_PLAYER_ARMY_SIZE 146
//TILE_SELECTED 172
//TILE_SOURCE_SELECTED 198
//TILE_SELECTION_DONE 224
//TILE_BLACK_PYRAMID_LEVEL 237
//TILE_RED_PYRAMID_LEVEL 250
//TILE_BLUE_PYRAMID_LEVEL 263
//TILE_WHITE_PYRAMID_LEVEL 276
//PLAYER_VICTORY_POINTS 289
//PLAYER_BATTLE_POINTS 291
//PLAYER_PRAYER_POINTS 293
//PLAYER_AVAILABLE_ARMY_TOKENS 295
//PLAYER_ROW_ONE_MOVE_USED 297
//PLAYER_ROW_ONE_RECRUIT_USED 299
//PLAYER_ROW_TWO_MOVE_USED 301
//PLAYER_ROW_TWO_UPGRADE_PYRAMID_USED 303
//PLAYER_ROW_TWO_PRAY_USED 305
//PLAYER_ROW_THREE_PRAY_USED 307
//PLAYER_ROW_THREE_BUILD_WHITE_USED 309
//PLAYER_ROW_THREE_BUILD_RED_USED 311
//PLAYER_ROW_THREE_BUILD_BLUE_USED 313
//PLAYER_ROW_THREE_BUILD_BLACK_USED 315
//PLAYER_ACTION_TOKEN_LEFT 317
//PLAYER_TEMPLE_COUNT 319
//PLAYER_BATTLE_CARD_AVALIABLE 321
//PLAYER_BATTLE_CARD_VISIBLE 331
//PLAYER_DAWN_TOKEN 351
//PLAYER_SILVER_TOKEN_USED 353
//PLAYER_GOLD_TOKEN_USED 355
//PLAYER_DAWN_STRENGTH 357
//PLAYER_SELECTED_ORDER 359
//PLAYER_ORDER 363
//PLAYER_POWERS 367
//RECRUIT_BEAST 495
//BEAST_POSITION 505
//BEAST_AVAILABLE 765
//DI_DISCARD 785
//CURRENT_PLAYER_DI 805
//CURRENT_PLAYER_ACTIVATED_DI 825
//DI_CARD_PER_PLAYER 835
//STATE_VETO_PLAYER 837
//STATE_VETO_DI_CARD 839
//STATE_PLAYER_VETO_DONE 849
//STATE_PLAYER_DOING_VETO_ON_VETO 851
//MOVE_FREE_BREACH_WALL 853
//MOVE_FREE_TELEPORT 854
//AVAILABLE_DI 855
//PICK_DI_STATE 875
//PICK_DI_MOVE_REST_TO_DISCARD 877
//RAINING_FIRE_STATE 878
//ESCAPE_PICKED 880
//ESCAPE_TILE_PICKED 881
//STATE_PICK_ATTACKER_DIVINE_WOUND 882
//STATE_PICK_DEFENDER_DIVINE_WOUND 884
//STATE_PICK_ATTACKER_TACTICAL_CHOICE 886
//STATE_PICK_DEFENDER_TACTICAL_CHOICE 888
//STATE_PICK_ESCAPE 890
//STATE_ESCAPE_SELECT_TILE 892
//STATE_ACTIVATE_OPTIONAL_TEMPLE 894
//STATE_PICK_FINAL_DI_CARDS 896
//TOTAL_STATE_COUNT 898