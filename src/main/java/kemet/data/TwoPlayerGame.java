...
public class TwoPlayerGame implements GameFactory {
	...
	public static boolean PLAYER_ONE_RANDOM = false;
	...
	public static boolean PLAYER_TWO_RANDOM = false;
	...
	private void createPlayers() {
		...
		} else if (PLAYER_ONE_RANDOM) {
			createRandomPlayer(firstPlayerName);
		} else {
		...
		} else if (PLAYER_TWO_RANDOM) {
			createRandomPlayer(secondPlayerName);
		} else {
