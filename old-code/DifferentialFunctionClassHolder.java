...
//            BaseOp.class    //Exclude x/y/z, n, numProcessed, extraArgs, etc
    ...
    private DifferentialFunctionClassHolder() {
        ...
        try {
			...
			ClassLoader classLoader = DifferentialFunctionClassHolder.class.getClassLoader();
			ClassPath from = com.google.common.reflect.ClassPath.from(classLoader);
			info = from.getTopLevelClassesRecursive("org.nd4j.linalg.api.ops");
        } catch (IOException e){
            //Should never happen
